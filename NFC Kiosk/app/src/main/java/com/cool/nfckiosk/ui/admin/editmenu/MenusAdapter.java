...
import com.cool.nfckiosk.databinding.MenuEditItemBinding;
import com.cool.nfckiosk.databinding.MenuEditItemBinding;
...
public class MenusAdapter extends ListAdapter<Menu, MenusAdapter.MenuViewHolder> {
    ...
    class MenuViewHolder extends RecyclerView.ViewHolder {
        ...
        private final MenuEditItemBinding binding;

        public MenuViewHolder(MenuEditItemBinding binding) {
    ...
    public MenuViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MenuEditItemBinding binding = MenuEditItemBinding.inflate(layoutInflater, parent, false);
